...
namespace XBMCRemoteRT.Pages.Files
{
    ...
    public sealed partial class AllSourcesPage : Page
    {
        ...
        {
            GlobalVariables.CurrentTracker.SendView("AllFilesPage");
        ...
        private async void ReloadAll()
        {
            ...
            allSources = await RPCWrappers.Files.GetSources("video");
            VideoFilesListView.ItemsSource = allSources;

            allSources = await RPCWrappers.Files.GetSources("music");
            MusicFilesListView.ItemsSource = allSources;
